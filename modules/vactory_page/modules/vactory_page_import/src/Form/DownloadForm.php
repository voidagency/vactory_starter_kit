...
class DownloadForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    if (isset($_SESSION['dynamic_page_import_file_download'])) {
      $file_uri = $_SESSION['dynamic_page_import_file_download'];
      unset($_SESSION['dynamic_page_import_file_download']);
    ...
    $form['go_back_link'] = [
      ...
      '#url' => Url::fromRoute('vactory_page_import.export'),
      '#attributes' => [
        'class' => ['button', 'button--primary'],
      ],
    ];
