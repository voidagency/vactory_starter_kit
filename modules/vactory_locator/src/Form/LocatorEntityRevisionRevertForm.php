...
/**
 * Provides a form for reverting a Locator Entity revision.
 *
 * @ingroup vactory_locator
 */
class LocatorEntityRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new LocatorEntityRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'locator_entity_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Locator Entity: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    \Drupal::messenger()->addMessage(t('Locator Entity %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\vactory_locator\Entity\LocatorEntityInterface $revision
