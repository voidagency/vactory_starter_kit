...
namespace Drupal\vactory_event\Plugin\vactory_dynamic_field\Platform;
...
class VactoryEvents extends VactoryDynamicFieldPluginBase {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $instance->setWidgetsPath($instance->extensionPathResolver->getPath('module', 'vactory_event') . '/widgets');
    return $instance;
  }
