...
/**
 * Provides a "Vactory Footer Block 3" block.
 *
 * @Block(
 *   id = "vactory_footer_block3",
 *   admin_label = @Translation("Vactory Footer Block V3"),
 *   category = @Translation("Footers")
 * )
 */
class VactoryFooterBlock3 extends BlockBase {
