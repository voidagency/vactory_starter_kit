(function ($) {
  ...
  googleMapFieldSetter = function (delta) {
    ...
    btns[Drupal.t('Insert map')] = function () {
      ...
      $('.geofield-lat').prop('value', latlng.lat()).attr('value', latlng.lat());
      $('.geofield-lon').prop('value', latlng.lng()).attr('value', latlng.lng());
    ...
    var lat = $('.geofield-lat').attr('value');
    var lon = $('.geofield-lon').attr('value');
