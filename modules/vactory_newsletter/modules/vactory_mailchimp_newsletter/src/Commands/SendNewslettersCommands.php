...
class SendNewslettersCommands extends DrushCommands {
  ...
  public function sendNewsletters() {
    ...
    $list_id = \Drupal::service('vactory_newsletter.campaigns.manage')->mailchimpGetInfos()['list_id'];
    ...
    \Drupal::logger('newsletter_mailchimp')->notice('Sending Newsletters has been completed.');
  }
