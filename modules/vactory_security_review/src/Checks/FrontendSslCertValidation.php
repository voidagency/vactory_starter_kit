 ...
 */
class FrontendSslCertValidation extends Check {
  ...
  public function __construct() {
    parent::__construct();
    $this->targetedEnv = static::FRONTEND_CONTEXT;
  ...
  public function getTitle() {
    return 'Frontend SSL cert validation';
  }
  ...
  public function getMachineTitle() {
    return 'front_ssl_cert_validation';
  }
