...
/**
 * Access controller for the Calendar slot entity.
 *
 * @see \Drupal\vactory_calendar\Entity\CalendarSlot.
 */
class CalendarSlotAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\vactory_calendar\Entity\CalendarSlotInterface $entity */
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        if (!$entity->isPublished()) {
          ...
          return AccessResult::allowedIfHasPermission($account, 'view unpublished calendar slot entities');
        }
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit calendar slot entities');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete calendar slot entities');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add calendar slot entities');
  }
