...
namespace Drupal\vactory_forums\Plugin\vactory_dynamic_field\Platform;
...
class VactoryForum extends VactoryDynamicFieldPluginBase {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $instance->setWidgetsPath($instance->extensionPathResolver->getPath('module', 'vactory_forums') . '/widgets');
    return $instance;
  }
