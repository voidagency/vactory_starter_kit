...
namespace Drupal\vactory_governance\Plugin\vactory_dynamic_field\Platform;
...
class VactoryGouvernance extends VactoryDynamicFieldPluginBase {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $instance->setWidgetsPath($instance->extensionPathResolver->getPath('module', 'vactory_governance') . '/widgets');
    return $instance;
  }
