...
namespace Drupal\vactory_webform_remote_post\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "vactory_remote_post",
 *   label = @Translation("Vactory Remote post"),
 *   category = @Translation("External"),
 *   description = @Translation("Posts webform submissions to a URL with field mapping."),
 ...
 * )
 */
class VactoryRemotePostWebformHandler extends WebformHandlerBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($webform_fields as $webform_field_key) {
      $form['fields_mapping'][$webform_field_key] = [
        '#markup' => '<tr><td>' . $webform_field_key . '</td>',
      ];
      $form['fields_mapping'][$webform_field_key . '_remote_key'] = [
        '#type' => 'textfield',
